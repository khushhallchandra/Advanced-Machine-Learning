...
def model(X, w, w2, w3, w4, w_o, p_keep_conv, p_keep_hidden,im_size,phase_train):
    ...
    l3a = tf.nn.relu6(batch_norm(tf.nn.conv2d(l2, w3,strides=[1, 1, 1, 1], padding='SAME'),im_size*4,phase_train)) 
...
py_x = model(X, w, w2, w3, w4, w_o, p_keep_conv, p_keep_hidden,32,phase_train)
